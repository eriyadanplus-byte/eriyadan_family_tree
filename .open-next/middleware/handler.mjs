...
Object.defineProperty = function(o, p, a) {
  ...
  globalThis.openNextDebug = false;globalThis.openNextVersion = "4.0.1";globalThis.nextVersion = "15.5.16";
...
// node_modules/@opennextjs/cloudflare/node_modules/@opennextjs/aws/node_modules/cookie/dist/index.js
var require_dist = __commonJS({
  "node_modules/@opennextjs/cloudflare/node_modules/@opennextjs/aws/node_modules/cookie/dist/index.js"(exports) {
    "use strict";
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let bt = /* @__PURE__ */ new Set(["super_admin", "editor", "contributor"]);
      function bu(a10) {
        let b2 = a10.cookies.get("session"), { pathname: c2 } = a10.nextUrl;
        if (c2.startsWith("/_next") || c2.startsWith("/favicon") || c2.startsWith("/fonts") || c2.startsWith("/images")) return S.next();
        let d2 = b2?.value ? function(a11) {
          try {
            let b3 = a11.split(".")[1];
            if (!b3) return null;
            let c3 = atob(b3.replace(/-/g, "+").replace(/_/g, "/"));
            return JSON.parse(c3);
          } catch {
            return null;
          }
        }(b2.value) : null;
        if (("/" === c2 || "/login" === c2 || "/signup" === c2) && b2?.value) return S.redirect(new URL("/tree", a10.url));
        if (d2?.mustChangePassword === true && "/change-password" !== c2 && !c2.startsWith("/api/") && "/logout" !== c2) return S.redirect(new URL("/change-password", a10.url));
        if (c2.startsWith("/admin")) {
          if (!b2?.value) {
            let b3 = a10.nextUrl.clone();
            return b3.pathname = "/login", b3.searchParams.set("redirect", c2), S.redirect(b3);
          }
          let e3 = d2?.role;
          if (!e3 || !bt.has(e3)) return S.redirect(new URL("/tree", a10.url));
        }
        if ((c2.startsWith("/tree") || c2.startsWith("/profile") || c2.startsWith("/search") || c2.startsWith("/settings")) && !b2?.value) {
          let b3 = a10.nextUrl.clone();
          return b3.pathname = "/login", b3.searchParams.set("redirect", c2), S.redirect(b3);
        }
        let e2 = S.next();
        return e2.headers.set("X-Frame-Options", "DENY"), e2.headers.set("X-Content-Type-Options", "nosniff"), e2.headers.set("Referrer-Policy", "strict-origin-when-cross-origin"), e2.headers.set("Permissions-Policy", "camera=(), microphone=(), geolocation=(), payment=(), usb=(), magnetometer=(), gyroscope=()"), e2.headers.set("Content-Security-Policy", "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com data:; img-src 'self' data: https: blob: https://*.supabase.co; connect-src 'self' https://*.supabase.co https://fonts.gstatic.com; object-src 'self' data:"), e2;
      }
      let bv = { matcher: ["/((?!_next/static|_next/image|favicon.ico|public/).*)"] };
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let bw = { ...f }, bx = bw.middleware || bw.default, by = "/src/middleware";
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/cloudflare/node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "src/middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|public\\/).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$"] }];
...
var BuildId = "9wMeYwWBC3Xtr9nLep5Nv";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/admin", "regex": "^/admin(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin(?:/)?$" }, { "page": "/admin/add-member", "regex": "^/admin/add\\-member(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/add\\-member(?:/)?$" }, { "page": "/admin/approvals", "regex": "^/admin/approvals(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/approvals(?:/)?$" }, { "page": "/admin/archive", "regex": "^/admin/archive(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/archive(?:/)?$" }, { "page": "/admin/audit", "regex": "^/admin/audit(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/audit(?:/)?$" }, { "page": "/admin/credentials", "regex": "^/admin/credentials(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/credentials(?:/)?$" }, { "page": "/admin/founding", "regex": "^/admin/founding(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/founding(?:/)?$" }, { "page": "/admin/help", "regex": "^/admin/help(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/help(?:/)?$" }, { "page": "/admin/lineage", "regex": "^/admin/lineage(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/lineage(?:/)?$" }, { "page": "/admin/members", "regex": "^/admin/members(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/members(?:/)?$" }, { "page": "/admin/permissions", "regex": "^/admin/permissions(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/permissions(?:/)?$" }, { "page": "/admin/settings", "regex": "^/admin/settings(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/settings(?:/)?$" }, { "page": "/archive", "regex": "^/archive(?:/)?$", "routeKeys": {}, "namedRegex": "^/archive(?:/)?$" }, { "page": "/auth/callback", "regex": "^/auth/callback(?:/)?$", "routeKeys": {}, "namedRegex": "^/auth/callback(?:/)?$" }, { "page": "/change-password", "regex": "^/change\\-password(?:/)?$", "routeKeys": {}, "namedRegex": "^/change\\-password(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }, { "page": "/help", "regex": "^/help(?:/)?$", "routeKeys": {}, "namedRegex": "^/help(?:/)?$" }, { "page": "/login", "regex": "^/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/login(?:/)?$" }, { "page": "/manifest.webmanifest", "regex": "^/manifest\\.webmanifest(?:/)?$", "routeKeys": {}, "namedRegex": "^/manifest\\.webmanifest(?:/)?$" }, { "page": "/offline", "regex": "^/offline(?:/)?$", "routeKeys": {}, "namedRegex": "^/offline(?:/)?$" }, { "page": "/profile", "regex": "^/profile(?:/)?$", "routeKeys": {}, "namedRegex": "^/profile(?:/)?$" }, { "page": "/search", "regex": "^/search(?:/)?$", "routeKeys": {}, "namedRegex": "^/search(?:/)?$" }, { "page": "/settings", "regex": "^/settings(?:/)?$", "routeKeys": {}, "namedRegex": "^/settings(?:/)?$" }, { "page": "/signup", "regex": "^/signup(?:/)?$", "routeKeys": {}, "namedRegex": "^/signup(?:/)?$" }, { "page": "/tree", "regex": "^/tree(?:/)?$", "routeKeys": {}, "namedRegex": "^/tree(?:/)?$" }, { "page": "/tree/add", "regex": "^/tree/add(?:/)?$", "routeKeys": {}, "namedRegex": "^/tree/add(?:/)?$" }], "dynamic": [{ "page": "/admin/help/[id]", "regex": "^/admin/help/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/admin/help/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/admin/users/[id]/reset-password", "regex": "^/api/admin/users/([^/]+?)/reset\\-password(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/users/(?<nxtPid>[^/]+?)/reset\\-password(?:/)?$" }, { "page": "/api/help/grants/[id]", "regex": "^/api/help/grants/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/help/grants/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/help/threads/[id]", "regex": "^/api/help/threads/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/help/threads/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/help/threads/[id]/assign", "regex": "^/api/help/threads/([^/]+?)/assign(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/help/threads/(?<nxtPid>[^/]+?)/assign(?:/)?$" }, { "page": "/api/help/threads/[id]/messages", "regex": "^/api/help/threads/([^/]+?)/messages(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/help/threads/(?<nxtPid>[^/]+?)/messages(?:/)?$" }, { "page": "/api/help/threads/[id]/resolve", "regex": "^/api/help/threads/([^/]+?)/resolve(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/help/threads/(?<nxtPid>[^/]+?)/resolve(?:/)?$" }, { "page": "/api/members/[id]", "regex": "^/api/members/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/members/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/members/[id]/avatar", "regex": "^/api/members/([^/]+?)/avatar(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/members/(?<nxtPid>[^/]+?)/avatar(?:/)?$" }, { "page": "/profile/[id]", "regex": "^/profile/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/profile/(?<nxtPid>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [{ "source": "/(.*)", "headers": [{ "key": "X-Frame-Options", "value": "DENY" }, { "key": "X-Content-Type-Options", "value": "nosniff" }, { "key": "Referrer-Policy", "value": "strict-origin-when-cross-origin" }, { "key": "Permissions-Policy", "value": "camera=(), microphone=(), geolocation=()" }, { "key": "Content-Security-Policy", "value": "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: blob:; connect-src 'self' https://*.supabase.co https://fonts.gstatic.com" }], "regex": "^(?:/(.*))(?:/)?$" }, { "source": "/_next/static/(.*)", "headers": [{ "key": "Cache-Control", "value": "public, max-age=31536000, immutable" }], "regex": "^/_next/static(?:/(.*))(?:/)?$" }, { "source": "/avatars/(.*)", "headers": [{ "key": "Cache-Control", "value": "public, max-age=86400, stale-while-revalidate=604800" }], "regex": "^/avatars(?:/(.*))(?:/)?$" }, { "source": "/sw.js", "headers": [{ "key": "Cache-Control", "value": "public, max-age=0, must-revalidate" }], "regex": "^/sw\\.js(?:/)?$" }];
var PrerenderManifest = { "version": 4, "routes": { "/_not-found": { "initialStatus": 404, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/manifest.webmanifest": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "application/manifest+json", "x-next-cache-tags": "_N_T_/layout,_N_T_/manifest.webmanifest/layout,_N_T_/manifest.webmanifest/route,_N_T_/manifest.webmanifest" }, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/manifest.webmanifest", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/favicon.ico": { "initialStatus": 301, "initialHeaders": { "location": "http://localhost:3000/icons/apple-touch-icon.png", "x-next-cache-tags": "_N_T_/layout,_N_T_/favicon.ico/layout,_N_T_/favicon.ico/route,_N_T_/favicon.ico" }, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/favicon.ico", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin", "dataRoute": "/admin.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/settings": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/settings", "dataRoute": "/admin/settings.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/archive": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/archive", "dataRoute": "/archive.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/credentials": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/credentials", "dataRoute": "/admin/credentials.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/add-member": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/add-member", "dataRoute": "/admin/add-member.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/change-password": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/change-password", "dataRoute": "/change-password.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/members": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/members", "dataRoute": "/admin/members.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/auth/callback": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/auth/callback", "dataRoute": "/auth/callback.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/approvals": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/approvals", "dataRoute": "/admin/approvals.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/login": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/login", "dataRoute": "/login.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/offline": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/offline", "dataRoute": "/offline.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/help": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/help", "dataRoute": "/help.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/", "dataRoute": "/index.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/search": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/search", "dataRoute": "/search.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/profile": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/profile", "dataRoute": "/profile.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/signup": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/signup", "dataRoute": "/signup.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/archive": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/archive", "dataRoute": "/admin/archive.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/lineage": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/lineage", "dataRoute": "/admin/lineage.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/audit": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/audit", "dataRoute": "/admin/audit.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/tree/add": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/tree/add", "dataRoute": "/tree/add.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/tree": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/tree", "dataRoute": "/tree.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/founding": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/founding", "dataRoute": "/admin/founding.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/settings": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/settings", "dataRoute": "/settings.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/help": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/help", "dataRoute": "/admin/help.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/permissions": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/permissions", "dataRoute": "/admin/permissions.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "3c19685193c41a6818c2ad2d1ab7dfeb", "previewModeSigningKey": "60e0b883c04f3886b1a5abf1abdf7d488fc8e87b8b03693585297244ff59495b", "previewModeEncryptionKey": "cae70048f656820f6219e6d8648f1bcddf75738b723118ee118720a20fa62752" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|public\\/).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico|public/).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "9wMeYwWBC3Xtr9nLep5Nv", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "zN+lJCyV9Y9w8qDYv2o8+OMM+ag7YFsSLgSWxZj4anc=", "__NEXT_PREVIEW_MODE_ID": "3c19685193c41a6818c2ad2d1ab7dfeb", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "60e0b883c04f3886b1a5abf1abdf7d488fc8e87b8b03693585297244ff59495b", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "cae70048f656820f6219e6d8648f1bcddf75738b723118ee118720a20fa62752" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/manifest.webmanifest/route": "/manifest.webmanifest", "/api/admin/approval-scopes/route": "/api/admin/approval-scopes", "/api/admin/audit/route": "/api/admin/audit", "/api/admin/lineage/route": "/api/admin/lineage", "/api/admin/change-password/route": "/api/admin/change-password", "/api/admin/stats/route": "/api/admin/stats", "/api/admin/config/route": "/api/admin/config", "/api/admin/users/[id]/reset-password/route": "/api/admin/users/[id]/reset-password", "/api/admin/spouses/route": "/api/admin/spouses", "/api/auth/account/route": "/api/auth/account", "/api/auth/logout/route": "/api/auth/logout", "/api/auth/session/route": "/api/auth/session", "/api/auth/permissions/route": "/api/auth/permissions", "/api/admin/users/route": "/api/admin/users", "/api/auth/login/route": "/api/auth/login", "/api/admin/approvals/route": "/api/admin/approvals", "/api/auth/view/route": "/api/auth/view", "/api/admin/users/create-for-member/route": "/api/admin/users/create-for-member", "/api/auth/signup/search/route": "/api/auth/signup/search", "/api/config/public/route": "/api/config/public", "/api/export/route": "/api/export", "/api/health/route": "/api/health", "/api/help/grants/[id]/route": "/api/help/grants/[id]", "/api/help/threads/[id]/resolve/route": "/api/help/threads/[id]/resolve", "/api/auth/signup/route": "/api/auth/signup", "/api/help/grants/route": "/api/help/grants", "/api/help/threads/[id]/messages/route": "/api/help/threads/[id]/messages", "/api/help/threads/[id]/route": "/api/help/threads/[id]", "/api/help/threads/[id]/assign/route": "/api/help/threads/[id]/assign", "/api/help/stream/route": "/api/help/stream", "/api/members/relatives/route": "/api/members/relatives", "/api/members/[id]/avatar/route": "/api/members/[id]/avatar", "/api/members/couples/route": "/api/members/couples", "/api/help/threads/route": "/api/help/threads", "/api/test-db/route": "/api/test-db", "/api/presence/route": "/api/presence", "/api/user/change-password/route": "/api/user/change-password", "/favicon.ico/route": "/favicon.ico", "/api/members/[id]/route": "/api/members/[id]", "/api/tree/route": "/api/tree", "/api/members/route": "/api/members", "/admin/add-member/page": "/admin/add-member", "/admin/audit/page": "/admin/audit", "/admin/approvals/page": "/admin/approvals", "/admin/archive/page": "/admin/archive", "/admin/credentials/page": "/admin/credentials", "/admin/help/page": "/admin/help", "/admin/help/[id]/page": "/admin/help/[id]", "/admin/lineage/page": "/admin/lineage", "/admin/members/page": "/admin/members", "/admin/founding/page": "/admin/founding", "/admin/page": "/admin", "/admin/settings/page": "/admin/settings", "/admin/permissions/page": "/admin/permissions", "/auth/callback/page": "/auth/callback", "/archive/page": "/archive", "/change-password/page": "/change-password", "/help/page": "/help", "/login/page": "/login", "/offline/page": "/offline", "/profile/[id]/page": "/profile/[id]", "/profile/page": "/profile", "/search/page": "/search", "/page": "/", "/signup/page": "/signup", "/tree/add/page": "/tree/add", "/settings/page": "/settings", "/tree/page": "/tree" };
...
// node_modules/@opennextjs/cloudflare/node_modules/@opennextjs/aws/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
